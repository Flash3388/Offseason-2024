...
- Make sure both sensors are in use
...
- Small convension fixes: uses of RobotMap, constants and such
- Finish PR comments
- Test shooter with note
- Finish PID tuning

### Climb

- Test motion directions in conjuection with hard limit switches

### Arm

- Find out what's going on with the arm
- Add PIDF 

### Swerve

- Find out what's going on with the swerve: are there any problems
- Add the PathPlanner code, and fix it

### Vision

- Noam instructs about vision
- Work with Stav and Yahav
