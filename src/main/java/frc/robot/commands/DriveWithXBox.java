...
public class DriveWithXBox extends Command {
    ...
    public void execute() {
        ...
        driveX = Math.abs(xboxController.getLeftY() * RobotMap.ATTAINBLE_MAX_SPEED_MPS_SWERVE) > 0.1 ? driveX * driveX * Math.signum(driveX) * RobotMap.ATTAINBLE_MAX_SPEED_MPS_SWERVE : 0;
